...
async function crearPropuesta() {
  ...
  const datos = await inquirer.prompt([
    ...
    { type: 'input', name: 'propuesta', message: 'desea aceptar la propuesta: aceptar/no aceptar' }, 
    { type: 'input', name: 'fecha', message: 'Fecha (YYYY-MM-DD):' },
    { type: 'input', name: 'proyecto ', message: 'desea crear el proyecto o postergarlo: crear/aplazar' }, 
  ]);
